...
const MChangePassword = () => {
  ...
  const submitHandler = async (value, { resetForm }) => {
    // const body = {
    //   token:
    //     "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJtYXN0ZXJfaWQiOjEsImRhdGVfdGltZSI6IjIwMjMtMDUtMTYgMDU6MjI6MjAuMDQ4NDc4In0.vPkeslkG1FMHoodAuDVkNMLiUf1sQKZE750OMl4Z0oA",
    //   password: value.confirmPassword,
    // };
    // const res = await postData("/m_verify_reset_password", body);
    navigate("/master-success-password");
    resetForm();
  };
